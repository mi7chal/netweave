...
import { type CreateDevicePayload, DeviceType } from "@/types/api";
...
export function EditDeviceDialog({ open, onOpenChange, onSubmit, initialData }: EditDeviceDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px] bg-card/80 backdrop-blur-2xl border-border/40 shadow-2xl">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="grid gap-4 py-6 max-h-[60vh] overflow-y-auto scrollbar-hide px-1">
                        <FormInputField
