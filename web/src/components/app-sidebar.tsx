...
export function AppSidebar() {
  ...
  return (
    <Sidebar
      variant="inset"
      className="border-r border-border/10 bg-sidebar/40 backdrop-blur-3xl shadow-2xl"
    >
      <SidebarHeader className="h-16 flex items-center px-6 justify-start">
        <Link
          to="/"
          className="flex items-center gap-3 font-semibold group transition-all duration-300"
        >
          ...
          <span className="text-xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-foreground to-foreground/70 group-hover:to-primary/80 transition-all duration-300">
            NetWeave
          </span>
        </Link>
      </SidebarHeader>
                ...
                return (
                  <SidebarMenuItem key={item.name} className="px-2">
                    ...
                    >
                      <Link
                        to={item.href}
                        className="flex items-center gap-3 relative z-10 w-full px-3"
                      >
                        {isActive && (
                        ...
                        <item.icon
                          className={cn(
                            ...
                            isActive
                              ? "scale-110 drop-shadow-[0_0_8px_rgba(120,119,198,0.5)]"
                        ...
                        <span
                          className={cn(
                            ...
                            isActive && "text-primary/90 text-shadow-sm",
                          )}
                        >
                          {item.name}
                        </span>
