# NetWeave network manager and dashboard

## Overview
NetWeave is a lightweight IPAM and dashboard application written in Rust.
...
```bash
git clone https://github.com/mi7chal/netweave
cd netweave
cp .env.example .env
docker compose up -d
cargo run
